...
from processes import filter as fil
...
columns_and_value = [("name","str"),("age","num"),("city","str"),("comment","str")]
df = fil.definite_type_of_columns(df, columns_and_value)

filters = [("city","in",("cdmx", "mexico city"))]
df = fil.filter_data(df,filters)
print("The file has been filtered.")
